...
Script Purpose: Create the tables in the bronze schema that will store the source
CRM and ERP data.

WARNING: This script drops existing tables and creates new tables. All existing
data will be erased.
*/
